...
file = '{}Computed_Files/galaxy_properties_20K.npy'.format(ROOT)
c = np.load(file)
...
idxs = np.load('{}Computed_Files/sf_idtemp_idxs_20K.npy'.format(ROOT))
...
np.savetxt('{}Computed_Files/slopes_z_20K'.format(ROOT), slopes)
np.savetxt('{}Computed_Files/slope_errs_z_20K'.format(ROOT), slopes_err)
np.savetxt('{}Computed_Files/intercepts_9_z_20K'.format(ROOT), intercepts_9)
np.savetxt('{}Computed_Files/intercept_errs_z_20K'.format(ROOT), intercepts_err)
