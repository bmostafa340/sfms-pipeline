...
slopes = list(np.loadtxt('{}Computed_Files/slopes_z_20K'.format(ROOT)))
err = list(np.loadtxt('{}Computed_Files/slope_errs_z_20K'.format(ROOT)))
...
np.savetxt('{}Computed_Files/slopes_z_fit_20K'.format(ROOT), np.array([coeff, error]))
