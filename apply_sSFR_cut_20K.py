...
file = '{}Computed_Files/sf_idtemp_idxs_pure_uvj_20K.npy'.format(ROOT)
...
file = '{}Computed_Files/quiescent_idtemp_idxs_pure_uvj_20K.npy'.format(ROOT)
...
pure_uvj = np.load('{}Computed_Files/galaxy_properties_pure_uvj_20K.npy'.format(ROOT))
...
np.save('{}Computed_Files/galaxy_properties_20K.npy'.format(ROOT), sSFR_cut)
...
np.save('{}Computed_Files/sf_idtemp_idxs_20K.npy'.format(ROOT), sf_idtemp_idxs)
np.save('{}Computed_Files/quiescent_idtemp_idxs_20K.npy'.format(ROOT), quiescent_idtemp_idxs)
